                ...
                <form onSubmit={handleSubmit} className="bg-white rounded-3xl shadow-xl shadow-blue-900/5 p-8 border border-white/50 backdrop-blur-sm">
                    <div className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-[#195BAC] hover:bg-[#154a8f] text-white font-bold py-3.5 rounded-xl shadow-lg shadow-blue-500/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 group mt-2"
                        >
                            {isLoading ? (
